...
const ownedSession = {
  ...
  ip_masked: '203.0.113.*',
  clientVersion: '1.4.0',
  connectedAt: '26/8/24 08:00',
  lastSeenAt: '26/8/24 08:02',
  duration: '2 分钟',
  pendingExit: false
};
...
describe('Personal Ops portal', () => {
  ...
  it('renders the allowlisted activity fields in list and detail views', async () => {
    ...
    expect(operationRow.textContent).toContain('26/8/24 12:00');
    ...
    expect(document.querySelector('[data-detail-time]').textContent).toBe('26/8/24 12:00');
    expect(document.querySelector('[data-detail-end-time]').textContent).toBe('26/8/24 12:00');
