...
- [仓库级迁移架构快照](../docs/architecture-tauri-migration.md)：跨 WPF/Tauri 的迁移历史、发布边界和验收记录。

## 测试映射与故障注入

- C# 测试到 Rust/React 的完整映射：`docs/migration-baselines/tauri-test-mapping.md`
...
```powershell
# C# -> Rust/React 映射门禁（缺少任一 *Tests.cs 条目即失败）
