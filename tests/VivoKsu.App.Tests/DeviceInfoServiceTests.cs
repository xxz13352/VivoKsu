...
public class DeviceInfoServiceTests
{
    ...
    public async Task ReadAdbAsync_maps_getprop_output_into_device_details()
    {
        ...
        var service = new DeviceInfoService(new FastbootRsBackend(new PropertyNativeApi(properties)));
    ...
    {
        var service = new DeviceInfoService(new FastbootRsBackend(new FastbootInfoNativeApi()));
    ...
    private sealed class FastbootInfoNativeApi : IFastbootRsNativeApi
    {
